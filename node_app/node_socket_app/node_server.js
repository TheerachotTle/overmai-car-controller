...
const ANKI_DRIVE_CHARACTERISTIC_UUIDS = [
  "be15bee06186407e83810bd89c4d8df4",
...
var server = net.createServer({noDelay:true},function (client) {
  client.vehicles = [];
    ...
    data
      ...
      .forEach(function (line) {
        ...
        switch (command) {
          ...
          case "QUIT":
            client.vehicles.forEach(function (v) {
              v.disconnect();
            });
...
console.log(
  util.format("Node gateway started, port %s, car id %s", CURRENT_PORT, CURRENT_CAR_UUID)
);
